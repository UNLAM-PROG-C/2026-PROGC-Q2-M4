import { serializeSubResource, } from "./tscn-parser.js";
...
const RESOURCE_HEADER_ATTRS = new Set([
    "type",
    "load_steps",
    "format",
]);
...
export class TresParser {
        ...
        for (const section of sections) {
            ...
            switch (tag) {
                case "gd_resource": {
                    ...
                    if (headerExtra)
                        resource.header.extraAttrs = headerExtra;
    ...
    serialize(resource) {
        ...
        lines.push("[gd_resource" +
            ...
            ], resource.header.extraAttrs, resource.header.attrOrder) +
            "]");
